...
public class DocumentExtractedWithTemplateEvent {
	...
	public DocumentExtractedWithTemplateEvent(String extractId, String prepareId, String documentId, DocumentStatus docStatus, String docPath, String template) {
