...
public class OCRTemplateRequest {
	private int id;
	...
	private List<OCRTemplateMapItem> mapping;
	...
	public List<OCRTemplateMapItem> getMapping() {
		return mapping;
	}
	public void setMapping(List<OCRTemplateMapItem> mapping) {
	...
	public void setIsserviceinvoice(String isserviceinvoice) {
